...
# Đường dẫn mặc định (vẫn giữ để tìm nhãn nếu có thể)
BASE_DIR = './archive'
...
def main():
    ...
    gt_rgb = cv.imread(MASK_PATH) if os.path.exists(MASK_PATH) else None
...
# (7) Visualization
    ...
    cv.putText(final_view, miou_text, (20, new_H - 20), cv.FONT_HERSHEY_DUPLEX,
